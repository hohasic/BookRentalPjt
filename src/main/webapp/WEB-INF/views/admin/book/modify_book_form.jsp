	...
	<section>
		...
		<div id="section_wrap">
			...
			<div class="modify_book_form">
				...
				<form
					action="<c:url value='/book/admin/modifyBookConfirm' />"
					name="modify_book_form"
					method="post" 
					...
					<input type="text" name="b_pulish_year" value="${bookDto.b_pulish_year}" placeholder="INPUT BOOK PUBLISH YEAR"><br>
					<input type="text" name="b_isbn" value="${bookDto.b_isbn}" placeholder="INPUT BOOK ISBN"><br>
